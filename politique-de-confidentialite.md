...
- **Éditeur / responsable de traitement :** Marwin Verin (entreprise individuelle) —
...
- **Délégué à la protection des données (DPO) :** non désigné — au regard de la taille
  ...
  point de contact pour toute question relative aux données personnelles (voir
  section 11 « Contact »).

## 2. Données que nous collectons

| Catégorie | Données | Origine | Obligatoire ? |
|-----------|---------|---------|----------------|
| Compte | Adresse e-mail, pseudo de connexion, mot de passe (stocké **haché**, jamais en clair) | Toi, à l'inscription | Oui, pour créer un compte |
| Profil | Nom affiché, poids, taille, âge, sexe, objectif, matériel disponible, charges maximales (1RM) | Toi, facultatif | Non — l'app fonctionne aussi sans compte, en local |
...
taille, l'âge, le sexe, les charges maximales (1RM) et l'historique d'entraînement
constituent des données relatives à la forme physique. Nous ne
les collectons que si tu choisis de les saisir, dans le seul but de te fournir le
service (calcul de charge conseillée, suivi de progression). Elles ne sont **jamais**
revendues ni utilisées à des fins publicitaires.

Nous **ne collectons pas** : géolocalisation, contacts du carnet d'adresses, données de
santé médicale au sens strict (diagnostics, dossiers médicaux), identifiants
publicitaires, ni aucune donnée de carte bancaire (voir section 4.2).

## 3. Finalités et bases légales

| Finalité | Base légale (RGPD) |
|----------|--------------------|
| Créer et gérer ton compte, fournir le service | Exécution du contrat (art. 6.1.b) |
| Synchroniser ton profil et ton historique de séances entre appareils | Exécution du contrat (art. 6.1.b) |
| Gérer l'abonnement Premium et les achats intégrés | Exécution du contrat (art. 6.1.b) |
...
Nous ne **vendons** pas tes données et ne les partageons pas à des fins publicitaires.
...
Conformément aux articles 12 à 22 du RGPD, tu disposes des droits suivants sur tes
données personnelles :

- **Droit d'accès** (art. 15) : obtenir une copie des données te concernant.
- **Droit de rectification** (art. 16) : corriger des données inexactes ou incomplètes.
- **Droit à l'effacement** ou « droit à l'oubli » (art. 17) : demander la suppression
  de tes données, notamment via la suppression de compte.
- **Droit à la limitation du traitement** (art. 18).
- **Droit à la portabilité** (art. 20) : recevoir tes données dans un format
  structuré, couramment utilisé et lisible par machine.
- **Droit d'opposition** (art. 21), notamment au traitement fondé sur l'intérêt
  légitime (sécurité, diagnostics) ou à la mesure d'usage détaillée.
- **Droit de retirer ton consentement** à tout moment (art. 7.3), sans que cela
...
- **Directement dans l'Application :** Profil → Compte → « Exporter mes données »
...
Nous mettons en œuvre des mesures techniques et organisationnelles adaptées : mots de
passe hachés (bcrypt), communications chiffrées (HTTPS/TLS), stockage du jeton de
session dans l'espace sécurisé de l'appareil (Keychain/Keystore), limitation des
tentatives de connexion, révocation des sessions lors d'un changement de mot de passe,
en-têtes de sécurité HTTP, accès restreint aux données, journal d'audit. Aucune
méthode n'étant infaillible, nous ne pouvons garantir une sécurité absolue, mais nous
nous engageons à corriger sans délai toute vulnérabilité identifiée.

## 9. Mineurs

L'Application n'est pas destinée aux enfants de moins de **15 ans**, âge du
consentement numérique autonome fixé par l'article 45 de la loi Informatique et
...
Nous pouvons modifier cette Politique, notamment pour refléter l'activation du
paiement réel des abonnements (RevenueCat) ou l'ajout de nouveaux outils tiers. En cas
de changement substantiel, tu en seras informé(e) dans l'Application ou par e-mail
avant son entrée en vigueur. La date de dernière mise à jour figure en haut du
document.
